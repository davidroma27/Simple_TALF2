...
#line 218 "simple.tab.c" /* yacc.c:355  */
};
...
#line 235 "simple.tab.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "CTC_CADENA", "IDENTIFICADOR", "DOS_PUNTOS", "CUATRO_PUNTOS",
  "ASIGNACION", "FLECHA", "ASIG_SUMA", "ASIG_RESTA", "ASIG_MULT",
  "ASIG_DIV", "ASIG_RESTO", "ASIG_POT", "ASIG_DESPI", "ASIG_DESPD",
  "CTC_CARACTER", "CTC_ENTERA", "CTC_REAL", "OPERADOR", "DELIM",
  "RESERVADA", "';'", "$accept", "definicion_programa", "codigo_programa", YY_NULLPTR
};
#endif
